...
After completing the upgrade process, verify that your users are migrated succefully using the [influx v1 auth list](influxdb/v2.0/reference/cli/influx/v1/auth/list/) command.
